# ==============================================================================
# Metashape USGS Otomasyonu - v1.5.0 Stabil Safe Mode (LOG HATASIZ YAPI)
# DAA Mühendislik Bilişim - Deniz Aydınalp
# Güncelleme: 2025-12-09 | Tüm Loglama Hatalarını Önlemek İçin Özel Log Fonksiyonu Kaldırıldı
# ==============================================================================
...
def check_stop_criteria(prev_rmse):
    ...
    for m in chunk.markers:
        if m.reference.enabled:
            try:
                # KRİTİK DÜZELTME: Marker hatası için m.residual.norm() kullanılıyor.
...
def usgs_professional_workflow():
    ...
    chunk = Metashape.app.document.chunk
    Metashape.app.log(f"{timestamp} | --- DAA Mühendislik Fotogrametri USGS Workflow v1.5.0 Başladı ---", Metashape.Information)
